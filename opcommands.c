...
{
     char *URL1 = "http://192.168.0.170:8080/op/Health/network";  /*URLs*/
     char *URL2 = "http://192.168.0.170:8080/op/Health/system";
     char res;int count;
     if (argc < 2 || argc > 2)
     {
     ...
     struct sockaddr_in addr = {AF_INET, htons(80), inet_addr("192.168.0.113")}; /*port number & IP address*/
     ...
     if (connect(sockfd, (struct sockaddr *) &addr, sizeof(addr)) == 0)
     {
      ...
      for (i=0;i<2;i++)
      {
                    ...
                    case 0 : /*if network_restart*/
               {
                      ...
                      printf("\n-----------------------------------------------------------------------------------------------------\n");
                       ...
                       if(curl)
                       {
                        ...
                        {
                                   /* write log message*/
                              openlog("AP311 Gateway", LOG_PID | LOG_NDELAY, LOG_USER);
        ...
        else
        {
                   ...
                   printf("No network in the gateway");
